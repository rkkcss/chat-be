...
class ProfileResourceIT {
    ...
    public static Profile createEntity(EntityManager em) {
        Profile profile = new Profile().phoneNumber(DEFAULT_PHONE_NUMBER);
        // Add required entity
    ...
    public static Profile createUpdatedEntity(EntityManager em) {
        Profile profile = new Profile().phoneNumber(UPDATED_PHONE_NUMBER);
        // Add required entity
        User user = UserResourceIT.createEntity(em);
        em.persist(user);
        em.flush();
    ...
    @Test
    @Transactional
    void updateProfileMapsIdAssociationWithNewId() throws Exception {
    ...
    void putExistingProfile() throws Exception {
        ...
        // Disconnect from session so that the updates on updatedProfile are not directly saved in db
        em.detach(updatedProfile);
        updatedProfile.phoneNumber(UPDATED_PHONE_NUMBER);
    ...
    void partialUpdateProfileWithPatch() throws Exception {
        ...
        partialUpdatedProfile.phoneNumber(UPDATED_PHONE_NUMBER);
