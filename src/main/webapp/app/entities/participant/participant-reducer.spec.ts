...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARTICIPANT_LIST actions', async () => {
    ...
    it('dispatches FETCH_PARTICIPANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PARTICIPANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PARTICIPANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PARTICIPANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PARTICIPANT actions', async () => {
      const expectedActions = [
        {
