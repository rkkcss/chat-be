  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="chatBeApp.profile.home.createOrEditLabel" data-cy="ProfileCreateUpdateHeading">
            <Translate contentKey="chatBeApp.profile.home.createOrEditLabel">Create or edit a Profile</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('chatBeApp.profile.phoneNumber')}
                id="profile-phoneNumber"
                name="phoneNumber"
                data-cy="phoneNumber"
                type="text"
              />
              <ValidatedField id="profile-user" name="user" data-cy="user" label={translate('chatBeApp.profile.user')} type="select">
                <option value="" key="0" />
                {users
