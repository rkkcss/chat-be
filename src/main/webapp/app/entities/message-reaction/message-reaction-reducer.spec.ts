...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MESSAGEREACTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_MESSAGEREACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MESSAGEREACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MESSAGEREACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MESSAGEREACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MESSAGEREACTION actions', async () => {
      const expectedActions = [
        {
